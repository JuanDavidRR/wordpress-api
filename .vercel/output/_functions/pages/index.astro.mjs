...
import { d as getPageInfo, e as getLatestArticles } from '../chunks/wp_Bk021gkL.mjs';
/* empty css                                 */
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": title, "description": seo?.description }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<section class="max-w-6xl mx-auto px-4 mt-10"> <h2 class="text-3xl font-bold">Latest Technology Posts</h2> <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-8"> ${sortedPosts.map((post) => renderTemplate`${renderComponent($$result2, "BlogCard", $$BlogCard, { ...post })}`)} </section> </section> ` })}`;
